...
const concepts = [
  {
    ...
    imageSrc: '/assets/tokenizacion.png',
    link: 'https://youtu.be/ReiXmpZVcI0?si=AfC4QeoKJ_nHvHfT',
  },
  {
    icon: Anchor,
    ...
    imageSrc: '/assets/lematizacion.png',
    link: 'https://youtu.be/_N0zaPpyrK8?si=ikgKfeW9eIh2G2lZ',
  },
  {
    icon: Smile,
    ...
    imageSrc: '/assets/sentimientos.png',
    link: 'https://youtu.be/jxGudwp6bz8?si=jwX1y38f8SOfShRN',
  },
  {
    icon: Tag,
    ...
    imageSrc: '/assets/ner.png',
    link: 'https://www.ibm.com/es-es/think/topics/named-entity-recognition',
  },
  {
    icon: Folders,
    ...
    imageSrc: '/assets/topicos.png',
    link: 'https://www.ibm.com/es-es/think/topics/topic-modeling',
  },
  {
    icon: PenSquare,
    ...
    imageSrc: '/assets/nlg.png',
    link: 'https://www.computerweekly.com/es/definicion/Generacion-de-lenguaje-natural-o-NLG',
  },
];
